 ...
 * ******************************************************************************/
	class Image {
		 ...
		 */
		function thumb($name, $width, $height=0,$qz="th_"){
...
//  		return $this->createNewImage($newImg, $qz.$name,$imgInfo);    //返回新生成的缩略图的名称，以"th_"为前缀
            return $this->imageResize($srcImg,$size,$qz.$name,$imgInfo); //返回新生成的缩略图的名称，以"th_"为前缀
		}
		/** 
		* 为图片添加水印
...
// 				裁剪的位置超出了图片范围！
		...
		private function getNewSize($name, $width, $height=0,$imgInfo){	
		...
		//改变图片大小
		private function imageResize($srcImg,$size,$newName,$imgInfo){
